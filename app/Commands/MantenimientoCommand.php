...
class MantenimientoCommand extends BaseCommand
{
    ...
    protected $options = [
        '--roles' => 'Lista de roles separados por coma que tendrán acceso durante el mantenimiento',
        '--message' => 'Mensaje personalizado para mostrar en la página de mantenimiento',
    ];
    ...
    {
        $rolesParam = $params['roles'] ?? $params['r'] ?? null;
        $message = $params['message'] ?? $params['m'] ?? 'Sitio en mantenimiento';
