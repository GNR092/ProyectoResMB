...
if (!file_exists($installerLockFile)) {
    ...
    $routes->group('/', ['filter' => ['auth', 'mantenimiento']], function ($routes) {
        ...
        $routes->post('api/presupuesto-mensual/save-masivo', 'PresupuestoApiController::saveMasivo');
        ...
        $routes->get('api/presupuesto/comparativo-mensual/(:any)/(:num)/(:any)', 'ReportesController::getComparativoMensual/$1/$2/$3');
