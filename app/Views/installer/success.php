...
<body class="bg-gray-100 font-montserrat flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white p-8 md:p-12 rounded-lg shadow-xl w-full max-w-md text-center">
        ...
        <p class="text-gray-600 mb-4">La base de datos se ha creado, el usuario se ha configurado y el archivo .env se
        ...
        <p class="text-gray-700 text-sm">Redirigiendo a la página principal en <span id="countdown"
                class="font-bold">5</span> segundos...</p>
        <a href="/"
