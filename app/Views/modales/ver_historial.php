...
<div id="div-historial" class="p-4 flex flex-col max-h-[calc(100vh-140px)]">
    ...
    <!-- Footer sticky: paginación siempre visible, fuera del scroll de la tabla -->
    <div id="historial-footer-sticky" class="sticky bottom-0 z-20 bg-white border-t border-gray-200 py-3 -mx-4 px-4">
        <div id="paginacion-historial" class="flex flex-wrap justify-center gap-2 bg-white"></div>
    </div>
</div>
