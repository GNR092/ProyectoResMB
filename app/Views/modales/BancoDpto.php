    ...
    <form id="form-agregar-banco-dpto" class="space-y-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="flex flex-col sm:col-span-2">
                ...
                <select name="ID_Dpto" id="ID_Dpto" required class="w-full px-3 py-2 border rounded-lg bg-white">
                    ...
                    <?php foreach ($departamentos as $dpto): ?>
                        <option value="<?= $dpto['ID_Dpto'] ?>"><?= esc($dpto['Nombre']) ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="flex flex-col">
                ...
                <input type="text" name="Clabe" id="Clabe" placeholder="18 dígitos..." required class="w-full px-3 py-2 border rounded-lg">
            </div>
        </div>
