<div class="p-4">
    <h2 class="text-lg font-bold mb-4">Órdenes de compra</h2>

    <!-- Div Tabla Principal -->
    <div id="div-tabla-ordenes">
        <div class="overflow-x-auto">
            <table class="min-w-full border border-gray-300">
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="5" class="text-center px-4 py-2 border">No hay órdenes de compra aprobadas.</td>
                    </tr>
                <?php endif; ?>
                </tbody>
            </table>
        ...
        <!-- Paginación -->
        <div id="paginacion-ordenes-compra" class="flex justify-center mt-4 space-x-2"></div>
    </div>

    <!-- Div VER -->
    <div id="div-ver-orden" class="hidden">
        <h3 class="text-lg font-bold mb-4">Detalles de la orden</h3>
        <div class="cursor-pointer w-6 h-6 text-gray-600" onclick="regresarTablaOrdenCompra()">
