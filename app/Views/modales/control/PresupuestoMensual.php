        ...
        <div class="flex flex-col gap-1 self-end mb-0.5" x-show="departamentos.length > 0" x-cloak>
            <div class="flex items-center gap-2">
                <button @click="exportarAsignacionExcel()" 
                        ...
                        class="px-4 py-2 bg-emerald-600 text-white font-bold rounded-lg hover:bg-emerald-700 transition-colors shadow-sm flex items-center gap-2 text-xs">
                ...
                <button @click="exportarAnualExcel()" 
                        ...
                        class="px-4 py-2 bg-amber-500 text-white font-bold rounded-lg hover:bg-amber-600 transition-colors shadow-sm flex items-center gap-2 text-xs">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <tr class="bg-white hover:bg-gray-50 transition-colors duration-150">
                        <td class="px-6 py-2 border-b border-gray-200 text-gray-600 pl-12">
                            ...
                            <template x-if="grupo.es_manual == 1 || grupo.es_manual === true || grupo.es_manual === 't'">
                                <span class="ml-2 inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-bold bg-amber-100 text-amber-800 border border-amber-200" title="Gastos ingresados como indirectos">
                                    INDIRECTO
                                </span>
                            </template>
                        </td>
