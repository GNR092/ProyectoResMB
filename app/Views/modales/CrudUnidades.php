...
<div id="pantalla-lista-unidades" 
    ...
    <div id="form-filtros-unidades" class="flex flex-col sm:flex-row sm:items-center gap-4 mb-4">
        <div class="flex flex-1 gap-4 items-end">
            <div class="flex-1">
                <label for="buscar-nombre-unidad" class="block text-xs font-bold text-gray-500 uppercase mb-1">Nombre</label>
            ...
            <div class="flex-1 min-w-[200px]">
                <label for="filtro-lugar-unidad" class="block text-xs font-bold text-gray-500 uppercase mb-1">Lugar (Complejo)</label>
                <select id="filtro-lugar-unidad" multiple>
                    <?php if (!empty($places)): ?>
                        <?php foreach ($places as $place): ?>
                            <option value="<?= esc($place['Nombre_Corto']) ?>"><?= esc($place['Nombre_Corto']) ?></option>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </select>
            </div>
...
<div id="pantalla-agregar-unidad" class="hidden p-6 bg-white rounded-xl shadow-md">
    ...
    <h2 class="text-2xl font-semibold mb-4 text-center">Agregar Departamento De Operación</h2>
...
<div id="pantalla-editar-unidad" class="hidden p-6 bg-white rounded-xl shadow-md">
    ...
    <form id="form-editar-unidad" class="space-y-4">
        ...
        <div class="flex flex-col">
            <label for="editar-Nombre-unidad" class="mb-1 font-medium">Nombre</label>
